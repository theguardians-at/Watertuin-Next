...
export default function HomeHero({ heroImage, heroEyebrow, heroBadgeInfo }) {
  return (
    <div className="wt-home-hero">
      <style href="wt-home-hero" precedence="medium" dangerouslySetInnerHTML={{ __html: css }} />
      <section className="hero">
      <div className="hero__bg" data-cms-bg="homepage.hero_image" style={{ backgroundImage: heroImage ? `url(${heroImage})` : undefined }}></div>
      <div className="hero__content">
      <p className="hero__eyebrow" data-cms="homepage.hero_eyebrow" dangerouslySetInnerHTML={{ __html: heroEyebrow }}></p>
      ...
      <p className="hero__badge-info" data-cms="homepage.hero_badge_info" dangerouslySetInnerHTML={{ __html: heroBadgeInfo }}></p>
      </div>
