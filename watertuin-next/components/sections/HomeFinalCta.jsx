...
export default function HomeFinalCta({ ctaHeadline }) {
  return (
    <div className="wt-home-final-cta">
      ...
      <h2 className="final-cta__headline" data-cms="homepage.cta_headline" dangerouslySetInnerHTML={{ __html: ctaHeadline }}></h2>
