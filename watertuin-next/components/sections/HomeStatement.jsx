...
export default function HomeStatement({ conceptTag, conceptHeadline, conceptBody }) {
  return (
    <div className="wt-home-statement">
      ...
      <p className="statement__tag" data-cms="homepage.concept_tag" dangerouslySetInnerHTML={{ __html: conceptTag }}></p>
      <h2 className="statement__headline" data-cms="homepage.concept_headline" dangerouslySetInnerHTML={{ __html: conceptHeadline }}></h2>
      <p className="statement__body" data-cms="homepage.concept_body" dangerouslySetInnerHTML={{ __html: conceptBody }}></p>
