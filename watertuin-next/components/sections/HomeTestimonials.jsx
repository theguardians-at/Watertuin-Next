...
export default function HomeTestimonials({ testimonialItems, headline, rating, platform }) {
  return (
      ...
      <section className="testimonials">
        <div className="testimonials__inner">
          <div className="testimonials__header">
            <h2 className="testimonials__headline" dangerouslySetInnerHTML={{ __html: headline }}></h2>
            <div className="testimonials__meta">
              <p className="testimonials__rating" dangerouslySetInnerHTML={{ __html: rating }}></p>
              <p className="testimonials__platform" dangerouslySetInnerHTML={{ __html: platform }}></p>
            </div>
          </div>
          <div className="testimonials__grid">
            {(testimonialItems || []).map((item, i) => (
                <div className="testimonial-item" key={i}>
                  <div className="testimonial-item__stars" dangerouslySetInnerHTML={{ __html: item.stars }}></div>
                  <p className="testimonial-item__quote" dangerouslySetInnerHTML={{ __html: item.quote }}></p>
                  <p className="testimonial-item__author" dangerouslySetInnerHTML={{ __html: item.author }}></p>
                </div>
            ))}
          </div>
        </div>
