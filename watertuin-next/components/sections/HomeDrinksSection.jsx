...
export default function HomeDrinksSection({ drinksEyebrow, drinksHeadline, drinksBody }) {
  return (
    <div className="wt-home-drinks-section">
      ...
      <p className="drinks-section__eyebrow" data-cms="homepage.drinks_eyebrow" dangerouslySetInnerHTML={{ __html: drinksEyebrow }}></p>
      <h2 className="drinks-section__headline" data-cms="homepage.drinks_headline" dangerouslySetInnerHTML={{ __html: drinksHeadline }}></h2>
      <p className="drinks-section__body" data-cms="homepage.drinks_body" dangerouslySetInnerHTML={{ __html: drinksBody }}></p>
