...
export default function HomeLiveSection({ liveEyebrow, liveHeadline, liveBody }) {
  return (
    <div className="wt-home-live-section">
      ...
      <p className="live-section__eyebrow" data-cms="homepage.live_eyebrow" dangerouslySetInnerHTML={{ __html: liveEyebrow }}></p>
      <h2 className="live-section__headline" data-cms="homepage.live_headline" dangerouslySetInnerHTML={{ __html: liveHeadline }}></h2>
      <p className="live-section__body" data-cms="homepage.live_body" dangerouslySetInnerHTML={{ __html: liveBody }}></p>
